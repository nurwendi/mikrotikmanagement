import { getAllActiveUsers } from './mikrotik.js';
import db from './db';
...
export async function generateInvoices() {
    try {
        ...
        console.log(`Found ${activeUsers.length} active users from Mikrotik.`);
        ...
        for (const user of activeUsers) {
            ...
            const profile = user.profile; // e.g. "50Mbps"

            // Determine price from comment "RP. 150000" etc.
            let amount = 0;
            if (user.comment) {
